<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      <li class="header">Functions Admin</li>
      <!-- Optionally, you can add icons to the links -->
      <li{!!(Request::is('/administrator')) ? ' class="active"' : '' !!}>
        <a href="{{ URL::to('/administrator')}}"><i class="fa fa-home"></i> <span>Home</span></a>
      </li>
      ...
      <li class="treeview">
        <a href="#"><i class="fa fa-calendar-check-o"></i> <span>Registration</span> <i class="fa fa-angle-left pull-right"></i></a>
        <ul class="treeview-menu">
          <li class='active'><a href="{{ URL::to('/administrator/week/1') }}">Week 1</a></li>
      ...
      <li{!!(Request::is('troop')) ? ' class="active"' : '' !!}>
        <a href="{{ URL::to('/troop') }}"><i class="fa fa-users"></i> <span>Troops</span></a>
      </li>
      @if(Request::is('sclass') || Request::is('administrator/users') || Request::is('administrator/staff') ||
      Request::is('administrator/roster') || Request::is('administrator/meritbadge'))
      <li class="active treeview">
        ...
        <ul class="treeview-menu">
          ...
          <li{!!(Request::is('administrator/roster')) ? ' class="active"' : '' !!}><a href="{{ URL::to('/administrator/roster/') }}"><i class="fa fa-clipboard"></i> <span>Rosters</span></a></li>
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          ...
          <li><a href="{{ URL::to('/administrator/roster/') }}"><i class="fa fa-clipboard"></i> <span>Rosters</span></a></li>
